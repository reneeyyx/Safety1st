  ...
  return (
    <>
      {showLanding ? (
        ...
        <div
          className="min-h-screen text-safety-orange animate-fadeIn"
          style={{
        ...
        >
          ...
          <header className="backdrop-blur-sm sticky top-0 z-40" style={{ background: 'transparent' }}>
            <div className="container mx-auto px-6 py-4">
              <div
                ...
                className="flex items-center cursor-pointer transition-transform duration-200 hover:scale-105 w-fit"
              >
                {/* Logo on left */}
                <img
                  src="/logo.png"
          ...
          {/* Footer */}
          <footer className="border-t border-safety-orange/30 mt-16 py-6 bg-safety-black/50">
